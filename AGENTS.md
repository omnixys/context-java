...
> Repository development instructions for **context** (Shared Package).
> Stack: java-maven. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Request context propagation: tenant, principal, client metadata, transport.

- Repository path: `packages/java/context` (relative to the Omnixys root)
...
src/main/java/com/omnixys/context/
...
Tenant propagation primitives; thread-local/async propagation.
