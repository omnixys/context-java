<!-- repository: packages/java/context | kind: PACKAGE | stack: java-maven -->

# context — Skill: Package Development

> Workflow for context (packages/java/context). Execute this workflow before, during, and
> after changes in this repository.

## Repository Facts

- Kind: Shared Package
- Package: `com.omnixys:context` (version: 1.0.4)
- Runtime: Java 26 (Maven)
- Description: Request context propagation: tenant, principal, client metadata, transport.
- Architecture: src/main/java/com/omnixys/context/
...
- This package is published (`com.omnixys:context`); consumers pin versions and rely on SemVer.
